    ...
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-body">
            ...
            <table class="table table-sm table-bordered table-striped">
                <tr>
                    <th class="text-right col-3">supplier Kode :</th><td class="col-9">{{$supplier->supplier_kode }}</td>
                </tr>
                <tr>
                    <th class="text-right col-3">supplier nama :</th><td class="col-9">{{$supplier->supplier_nama }}</td>
                </tr>
                <tr>
                    <th class="text-right col-3">supplier alamat :</th><td class="col-9">{{$supplier->supplier_alamat }}</td>
                </tr>
            </table>
        </div>
