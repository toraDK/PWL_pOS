    ...
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-body">
            ...
            <table class="table table-sm table-bordered table-striped">
                <tr>
                    <th class="text-right col-3">kategori Kode :</th><td class="col-9">{{$kategori->kategori_kode }}</td>
                </tr>
                <tr>
                    <th class="text-right col-3">kategori nama :</th><td class="col-9">{{$kategori->kategori_nama }}</td>
                </tr>
            </table>
        </div>
