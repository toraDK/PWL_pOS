    ...
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-body">
            ...
            <table class="table table-sm table-bordered table-striped">
                <tr>
                    <th class="text-right col-3">Kategori :</th><td class="col-9">{{$barang->kategori->kategori_nama }}</td>
                </tr>
                <tr>
                    <th class="text-right col-3">kode barang :</th><td class="col-9">{{$barang->brang_kode }}</td>
                </tr>
                <tr>
                    <th class="text-right col-3">Nama barang :</th><td class="col-9">{{ $barang->barang_nama }}</td>
                </tr>
                <tr>
                    <th class="text-right col-3">harga beli :</th><td class="col-9">{{ $barang->harga_beli }}</td>
                </tr>
                <tr>
                    <th class="text-right col-3">harga jual :</th><td class="col-9">{{ $barang->harga_jual }}</td>
                </tr>
            </table>
        </div>
